<?php 
$channelId = 'UCqkv5zUTS-CipBIikBtezBA';
...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=' . $channelId . '&key=AIzaSyDrR48phY2mfjj45HkpGCO8J-wBlo8oW7o');
...
// latest video
$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyDrR48phY2mfjj45HkpGCO8J-wBlo8oW7o&channelId=' . $channelId . '&maxResults=1&order=date&part=snippet';
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#home">Alexander Almas S.</a>
    ...
    <div class="jumbotron" id="home">
      <div class="container">
        <div class="text-center">
          ...
          <h1 class="display-4">Alexander Almas Santosa</h1>
          <h3 class="lead">--------------------------</h3>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-5">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <div class="g-ytsubscribe" data-channelid="UCqkv5zUTS-CipBIikBtezBA" data-layout="default" data-count="default"></div>
              </div>
            </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4">
            ...
            <ul class="list-group mb-4">
              ...
              <li class="list-group-item">Maguwoharjo</li>
